            ...
            <main className="">
                ...
                <div className="max-w-4xl mx-auto px-4 py-8">
                    ...
                    <div className="my-8 space-y-6 text-gray-700">
                        <p>
                            A informação contida neste website é propriedade da StellarVest Asset Management, Unipessoal Lda.” (“StellarVest Asset Management”), com sede em Campo Grande 28, 3 D, 1700-093 Lisboa, matriculada na Conservatória do Registo Comercial de Lisboa sob o NIPC 514323736 e titular da licença de mediação imobiliária n.º 14298, e destina-se à divulgação da sua atividade.
                        </p>
                    </div>
                    ...
                    <div className="my-8 space-y-6 text-gray-700">
                        ...
                        <p>
                            Campo Grande, 28, 3 D, 1700-093 Lisboa<br />
                            1600-206 Lisboa
                        </p>
                    </div>
